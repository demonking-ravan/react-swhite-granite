            ...
            <section>
                <div className="relative">
                    ...
                    {/* <div
                        ...
                        style={{ background: "white", color: "black" }}
                    >
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" className="mb-4 text-4xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="12" cy="8" r="7"></circle>
                            <polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline>
                        </svg>
                        <h3 className="mb-6 text-center text-4xl font-semibold md:text-6xl">Customers love us</h3>
                        <p className="mb-8 max-w-lg text-center text-sm md:text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi illo officia atque iure voluptatibus necessitatibus odit cupiditate reprehenderit iusto quaerat!</p>
