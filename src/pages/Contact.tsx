...
export default function Contact() {
    return (
        <section className="sec_container">
            <div
                className="flex flex-wrap items-start justify-between gap-y-6 gap-x-20 lg:flex-nowrap"
            >
                <div
                    data-aos="fade-up-sm"
                    className="lg:max-w-lg lg:sticky lg:top-32 aos-init aos-animate"
                >
                    <h2 className="heading font-serif">
                        Contact Us For <strong>More Information</strong>
                    </h2>
                    <p className="mt-6"></p>
                    <blockquote>
                ...
                >
                    ...
                    >
                        ...
                        <div
                            input-wrapper=""
                            className="flex flex-col col-span-2 hidden text-sm message success"
                        >
                            <div
